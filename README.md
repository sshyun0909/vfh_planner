...
https://github.com/user-attachments/assets/d669bdc5-5c6e-43a4-97cc-f303b0716edd



https://github.com/user-attachments/assets/80b71829-77bb-4a43-a234-e8b9720e75ed

### Overview
This project implements a vector field histogram (VFH)-based obstacle avoidance algorithm in ROS2 Foxy.
The algorithm enables autonomous driving by dynamically adjusting the trajectory of the vehicle to avoid obstacles while moving to the desired goal point.

### Installation
- Ubuntu 20.04
- ROS2 FOXY
- OMO ROBOT R1 package

### Launch the Node
```
ros2 launch vfh_planner vfh_planner.launch.py
```
